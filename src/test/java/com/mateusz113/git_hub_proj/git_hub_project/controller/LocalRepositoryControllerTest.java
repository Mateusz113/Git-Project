...
public class LocalRepositoryControllerTest {
    ...
    @Test
    public void getLocalRepositoryData_ReturnsDataWithStatus200() throws Exception {
        String owner = "owner";
        String repositoryName = "repoName";
        RepositoryDto repositoryDto = buildRepositoryDto();
        when(repositoryService.getLocalRepositoryData(owner, repositoryName)).thenReturn(repositoryDto);
